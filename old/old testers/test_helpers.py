...
codes = data.get_codes("C:\\Users\\engrla\\NLP-Eval-for-DE\\Example\\pain_point_codes_desc")
#print(codes)
#print(helpers.get_testable_data("Pain points data-ground truth.txt"))

testable_data = data.get_testable_data("C:\\Users\\engrla\\NLP-Eval-for-DE\\Example\\Pain points data-ground truth.txt")
# print(testable_data)
...
# print(helpers.evaluate(testable_data[1], predictions[0], codes[1])[0])
# print(helpers.evaluate(testable_data[1], predictions[0], codes[1])[1])
print(scores.evaluate(testable_data[1], predictions[0], codes[1])[2])
